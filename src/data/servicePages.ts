...
export const servicePagesContent: Record<string, ServicePageContent> = {
  'building-inspection-surveys': {
    ...
    metaTitle: 'Building Inspection & Structural Surveys – Southampton, Winchester & London | IBFS',
  ...
  'damp-condensation-surveys': {
    ...
    metaTitle: 'Independent Damp & Condensation Surveys – Southampton, Winchester & London | IBFS',
  ...
  'indoor-air-quality-ventilation': {
    ...
    metaTitle: 'Indoor Air Quality Testing & Ventilation Audits – Winchester, London & Southampton | IBFS',
  ...
  'odour-voc-investigations': {
    ...
    metaTitle: 'Odour & VOC Investigations – London, Winchester & Southampton | IBFS',
  ...
  'materials-coatings-failure': {
    ...
    metaTitle: 'Materials & Coating Failure Analysis – South East & London | IBFS',
  ...
  'water-ingress-damage': {
    ...
    metaTitle: 'Water Ingress & Damage Surveys – London, Winchester & Southampton | IBFS',
  ...
  'asbestos-interpretation-disputes': {
    ...
    metaTitle: 'Asbestos Report Interpretation & Property Dispute Surveys – London & South East | IBFS',
  ...
  'ventilation-energy-audits': {
    ...
    metaTitle: 'Ventilation & Energy-Loss Audits – Condensation After Insulation | London & South East | IBFS',
  ...
  'decontamination-environmental': {
    ...
    metaTitle: 'Decontamination & Environmental Services – Fogging, Odour Removal | London | IBFS',
  ...
  'building-health-forensics': {
    ...
    metaTitle: 'Building-Related Health Forensics – Sick Building Syndrome | London & South East | IBFS',
